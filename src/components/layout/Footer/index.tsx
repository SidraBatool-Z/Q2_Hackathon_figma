              ...
              <div className="flex items-center">
                {socialsData.map((social) => (
                  <Link
                    ...
                    key={social.id}
                    target="_blank"
                    className="bg-black hover:bg-white hover:text-black text-white transition-all mr-3 w-7 h-7 rounded-full border border-black/20 flex items-center justify-center p-1.5"
                  >
                    {social.icon}
                  </Link>
                ))}
